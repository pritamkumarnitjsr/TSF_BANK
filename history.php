            ...
            <div class="row" >
                <div class="col-md-12" >
                    <div class="page-header clearfix">
                        <h2 class="center"  style="font-size:300%; color:red; font-family:serif;"><u>History </u></h2>
                    </div>
                    <?php
                        $host = 'localhost';
                    ...
                    <?php
                            ...
                            <table class='table table-bordered  table-striped'>
                                <tr>
                                    <td  style="font-size:140%; color:green; font-family:serif;">Sender</td>
                                    <td style="font-size:140%; color:green; font-family:serif;">Receiver</td>
                                    <td style="font-size:140%; color:green; font-family:serif;">Amount</td>
                                    <td style="font-size:140%; color:green; font-family:serif;">Date & Time</td>
